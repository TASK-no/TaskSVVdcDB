global <- quote({
  ...
  settings_seg <- list(Q16 = list(grun = list(sum_score_val = 4,
                                              type_val = "larger-equal"),
                                  vide = list(sum_score_val = 2,
                                              type_val = "larger-equal"),
                                  avan = list(sum_score_val = 2,
                                              type_val = "equal")),
                       Q17 = list(grun = list(sum_score_val = 3,
                                              type_val = "larger-equal"),
                                  vide = list(sum_score_val = 3,
                                              type_val = "equal"),
                                  avan = list(sum_score_val = 3,
                                              type_val = "equal")),
                       Q14 = list(grun = list(sum_score_val = 2,
                                              type_val = "larger-equal"),
                                  vide = list(sum_score_val = 3,
                                              type_val = "equal"),
                                  avan = list(sum_score_val = 2,
                                              type_val = "equal")),
                       Q19 = list(grun = list(sum_score_val = 2,
                                              type_val = "larger-equal"),
                                  vide = list(sum_score_val = 5,
                                              type_val = "equal"),
                                  avan = list(sum_score_val = 3,
                                              type_val = "equal")))
